    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.CharField(choices=[('High', 'Высокий'), ('Middle', 'Средний'), ('Low', 'Низкий')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=100)),
                ('description', models.TextField()),
                ('status', models.CharField(choices=[('On_consideration', 'Рассмотрение'), ('Accepted', 'Принято'), ('Denied', 'Отклонено')], default='On_consideration', max_length=50)),
                ('priority', models.CharField(choices=[('High', 'Высокий'), ('Middle', 'Средний'), ('Low', 'Низкий')], max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tasks.project')),
